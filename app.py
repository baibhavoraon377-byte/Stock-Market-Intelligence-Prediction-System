...
st.markdown("""
<div id="sb-toggle-btn" onclick="sbToggle()" title="Toggle sidebar">
...
(function () {
    ...
    function applyState() {
        var sb = getSidebar();
        if (!sb) return;
        var isOpen = sessionStorage.getItem(KEY) !== "0";
        isOpen ? sb.classList.remove("sb-hidden") : sb.classList.add("sb-hidden");
    }
